...
module.exports = new PluginWebpackConfig('sk.digitalorchestra.graylog.plugins.hexdec.HexDecFunctionsPlugin', loadBuildConfig(path.resolve(__dirname, './build.config')), {
